...
urlpatterns = [
    ...
    path('', views.ESignListView.as_view(), name='list'),
    path('create/', views.ESignCreateView.as_view(), name='create'),
    path('update/<int:pk>', views.ESignUpdateView.as_view(), name='update'),
